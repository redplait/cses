...
// solution for Tree Distances I
// see algo in book "Binary Tree Problems: Must for Interviews and Competitive Coding", pages 58-67
// main idea is after finding diameter to run dfs yet one time from newly discovered maxNode
// So complexity is 3 * O(N) - 2 dfs for diameter discovery + yet one additional
using namespace std;
